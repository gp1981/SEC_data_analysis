...
# Define the standardized Balance Sheet file path
...
# Transpose the Balanche Sheet statement of JAKKS Pacific Inc. in standardized format
df_std_BS_t <- transpose_df(df_std_BS, standardized_BS)
...
# Define the standardized Income Statement file path
...
# Transpose the Income Statement of JAKKS Pacific Inc. in standardized format
df_std_IS_t <- transpose_df(df_std_IS, standardized_IS)
...
# Define the standardized Cash Flow Statement file path
...
df_std_CF_t <- transpose_df(df_std_CF, standardized_IS)
